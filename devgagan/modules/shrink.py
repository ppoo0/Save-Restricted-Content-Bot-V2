...
async def token_handler(client, message):
    ...
    if len(message.command) <= 1:
        ...
        join_button = InlineKeyboardButton("Join Channel", url="https://t.me/neetumamvoca")
        premium = InlineKeyboardButton("Get Premium", url="https://t.me/RAJPUT681830")  # Callback for Help button
